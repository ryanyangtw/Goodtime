class MyDevise::RegistrationsController < ApplicationController # Devise::RegistrationsController
  ...
  def user_update_params
    params.require(:user).permit(:email, :name, :nickname, :phone_number, :address_country, :address_district, :birthday_year, :birthday_month, :birthday_date)
  end
  ...
  def set_birthday_day_hash
    ...
    for i in 1..31
      text = i.to_s + "日"
      h = {"#{text}": i.to_s}
      @birthday_date_hash.merge!(h) 
    end
  end

  def set_addres_convert_table
    @addres_convert_table = {
      "台北市": {
        "中正區": "100",
        "大同區": "103",
        "中山區": "104",
